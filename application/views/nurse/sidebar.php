...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block">Nurse User</a>
            </div>
        </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                <li class="nav-item">
                <a href="<?php echo base_url('nurse/queue'); ?>" class="nav-link <?php if($title=="Nurse's Queue") echo 'active';?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url('nurse/patient_list'); ?>" class="nav-link <?php if($title=="Patient List") echo 'active';?>">
