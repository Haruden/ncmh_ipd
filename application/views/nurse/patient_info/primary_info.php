                            ...
                            <div class="card">
                                <div class="card-header p-2">
                                    <ul class="nav nav-pills">
                                        <li class="nav-item"><a class="nav-link active" href="<?php echo base_url('nurse/primary_info'); ?>">Primary Information</a></li>
                                        <li class="nav-item"><a class="nav-link" href="<?php echo base_url('nurse/patients_id'); ?>">Patient's Identification</a></li>
