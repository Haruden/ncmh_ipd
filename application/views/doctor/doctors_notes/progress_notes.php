...
<script>
    ...
    $(function() {
        ...
        $( "#tbl_prognotes_length" ).find('label').after('<button class="btn btn-sm btn-success ml-3" data-toggle="modal" data-target="#modal-prognotes">Add Progress Notes  <i class="ml-1 fas fa-plus"></i></button>');
        // $('#example2').DataTable({
        //     "paging": true,
        //     "lengthChange": false,
        //     "searching": false,
