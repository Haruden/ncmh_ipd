                            ...
                            <div class="card">
                                <div class="card-header p-2">
                                    <ul class="nav nav-pills">
                                        ...
                                        <li class="nav-item"><a class="nav-link active" href="#">Transfer Out Notes</a></li>
                                    ...
                                    <div class="tab-content">
                                        <div class="active tab-pane" id="activity">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <button class="btn btn-lg btn-success" data-toggle="modal" data-target="#trans-out-add">Add Notes</button>
                                            </div>
